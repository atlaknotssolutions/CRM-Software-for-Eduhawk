...
const getGoals = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ status: true, message: "Goals fetched", data });
  } catch (error) {
    res.status(500).json({
      status: false,
...
const getGoalById = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ status: true, message: "Goal fetched", data: mapGoal(goal) });
  } catch (error) {
    res.status(500).json({
      status: false,
      message: "Internal server error",
...
const createGoal = async (req, res) => {
  try {
    ...
    return res
      .status(201)
      .json({ status: true, message: "Goal created", data: mapGoal(goal) });
  } catch (error) {
    res.status(500).json({
      status: false,
      message: "Internal server error",
...
const updateGoal = async (req, res) => {
  try {
    ...
    const { title, description, progress, target, deadline, category, status } =
      req.body;
    ...
    return res
      .status(200)
      .json({ status: true, message: "Goal updated", data: mapGoal(goal) });
  } catch (error) {
    res.status(500).json({
      status: false,
      message: "Internal server error",
...
const deleteGoal = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ status: true, message: "Goal deleted", data: mapGoal(goal) });
  } catch (error) {
    res.status(500).json({
      status: false,
      message: "Internal server error",
