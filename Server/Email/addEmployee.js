function getAddEmployeeMailOptions(
  ...
  return {
    ...
    to: email,
    subject: "Welcome to EDU-HAWK CRM-System - Your Account Details",
    html: `<!DOCTYPE html>
			<html lang="en">
			<head>
				<meta charset="UTF-8">
				<title>Welcome to EDU-HAWK CRM-System</title>
				<style>
			...
			<body>
				<div class="container">
					<div class="header">
						<div class="title">Welcome to EDU-HAWK CRM-System!</div>
					</div>
					<div class="content">
						<p>Hi <strong>${name}</strong>,</p>
						<p>You have been added to the EDU-HAWK CRM-System as a new employee. Below are your account details:</p>
						<div class="details">
