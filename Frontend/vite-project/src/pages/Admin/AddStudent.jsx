...
//     "Pre Neet",
//   ]),
//   preferredCountry1: z.string().optional(),
//   preferredCountry2: z.string().optional(),
...
//       preferredCountry1: lead.preferredCountry1 || lead.preferredCountry || "",
//       preferredCountry2: lead.preferredCountry2 || "",
//       collegeName: lead.collegeName || "",
...
//                       <TableHead>Name</TableHead>
//                       <TableHead>Phone</TableHead>
//                       <TableHead>Phone2</TableHead>
//                       <TableHead>Gapyear</TableHead>
//                       <TableHead>Parent</TableHead>
//                       <TableHead>City</TableHead>
//                       <TableHead>Status</TableHead>
//                       <TableHead>Tag</TableHead>
...
//                           <TableCell>{getStatusBadge(lead.status)}</TableCell>
//                           <TableCell>{getTagBadge(lead.leadTag)}</TableCell>
//                           <TableCell>{lead.preferredCountry1 || "—"}</TableCell>
//                           <TableCell>
//                             {lead.budget
//                               ? `₹${Number(lead.budget).toLocaleString("en-IN")}`
//                               : "—"}
...
//                 <FormField
//                   control={formHook.control}
//                   name="preferredCountry1"
//                   render={({ field }) => (
//                     <FormItem>
//                       <FormLabel>Preferred Country 1</FormLabel>
//                       <Select
//                         onValueChange={field.onChange}
//                         value={field.value}
//                       >
...
//                 <FormField
//                   control={formHook.control}
//                   name="preferredCountry2"
//                   render={({ field }) => (
//                     <FormItem>
//                       <FormLabel>Preferred Country 2</FormLabel>
//                       <Select
//                         onValueChange={field.onChange}
//                         value={field.value}
//                       >
...
const AddStudent = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setUploadMsg({
        type: "success",
        text: `✅ Imported ${res.data.imported || 0} leads successfully!`,
      });
      clearFile();
      reload();
    } catch (err) {
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
                    ...
                    {loading ? (
                      ...
                      leads.map((lead, idx) => (
                        <TableRow key={lead._id}>
                          ...
                          <TableCell>{lead.gapYear || "—"}</TableCell>
                          <TableCell>{lead.parentName || "—"}</TableCell>
                          <TableCell>{lead.city || "—"}</TableCell>
                          <TableCell>{getStatusBadge(lead.status)}</TableCell>
                          <TableCell>{getTagBadge(lead.leadTag)}</TableCell>
                          <TableCell>{lead.preferredCountry1 || "—"}</TableCell>
                          <TableCell>{lead.preferredCountry2 || "—"}</TableCell>
                          <TableCell>{lead.neetStatus || "—"}</TableCell>
          ...
          <TabsContent value="upload">
            <Card className="dashboard-card max-w-2xl mx-auto">
              ...
              <CardContent className="space-y-6">
                <div
                  className={`border-2 border-dashed rounded-xl p-12 text-center transition-all cursor-pointer ${dragging ? "border-primary bg-primary/5" : "border-border"}`}
                  onDragOver={(e) => {
                    e.preventDefault();
                    setDragging(true);
                  }}
